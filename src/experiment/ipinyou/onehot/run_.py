...
if __name__ == '__main__':
    ...
    for experiment_id, (subject, sample_id, bins, alpha, hidden) in experiments:
        ...
        X_train, y_train, X_test, y_test, X_train_agge, X_test_agge, cols, conj_cols = \
            d_mgr.get_data(subject, bins, sample_id)
        ...
        dw.run({"train": X_train, "test": X_test},
               {"train": y_train, "test": y_test},
               subject + f";encoding=oh;features={X_train.shape[1]};bins={bins}",
               **nn_params)
